...
*/
// ---- Script zur Erstellung eines zu finanzierenden Mitarbeiters ----
document.addEventListener('DOMContentLoaded', function() {
    ...
    saveButton1.addEventListener('click', function(e) {
        ...
        // Stundensätze finden
        const satzObj = stundensatzMapping[entgeltgr] &&  stundensatzMapping[entgeltgr][stufe];
        ...
        let kosten = 0;
        if (jahr2025) kosten += jahr2025 * 52 * satzObj["2025"];
        if (jahr2026) kosten += jahr2026 * 52 * satzObj["2026"];
        if (jahr2027) kosten += jahr2027 * 52 * satzObj["2027"];
